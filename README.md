...
<br/>
**latest release: [2.0-alpha2](https://search.maven.org/artifact/pl.morgwai.base/grpc-scopes/2.0-alpha2/jar)**
([javadoc](https://javadoc.io/doc/pl.morgwai.base/grpc-scopes/2.0-alpha2))
